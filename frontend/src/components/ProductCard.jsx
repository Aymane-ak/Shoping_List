...
return (
    <div className="bg-white rounded-lg shadow-sm p-4 mb-3 flex items-center gap-3">                   
        ...
        <div className="flex-1"> 
            ...
            <p className="text-sm text-gray-500">   {product.nutriscore} </p> 
        </div>
        ...
        <button onClick={ () => OnDelete(product.id)} className="text-red-500 hover:text-red-700"> Supprimer </button>                                               
    </div>    
)
}
